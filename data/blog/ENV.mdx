...
summary: 'Las variables de entorno son valores que se establecen en el sistema operativo o entorno de ejecución y pueden ser accedidos desde una aplicación...'
---

<Image
  alt={`Environment Variables image`}
